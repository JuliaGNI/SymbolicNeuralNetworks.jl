module SymbolicNeuralNetworks
    ...
    using Symbolics
    # `SymbolicUtils` is imported (not just used transitively via `Symbolics`) because the
    # code generated by `build_nn_function` references `SymbolicUtils.Code.create_array`
    # directly; the name must resolve in this module when the RuntimeGeneratedFunction runs.
